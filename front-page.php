...
<head>
	...
	<!-- Theme CSS -->
	<link rel="stylesheet" type="text/css" href= "<?php echo get_template_directory_uri() . "/cprepowptheme/style.css"; ?>" />
...
<body>
	...
	<script src="wp-content/themes/cprepowptheme/assets/js/main.js"></script>
